...
<div class="card shadow">
  <h5 class="card-header text-white bg-info">Data Penilaian</h5>
    <div class="card-body">
    <h5> Periode <?= date('d-m-Y', strtotime($awal_periode)) ?> - <?= date('d-m-Y', strtotime($akhir_periode)) ?></h5><hr>
...
<div class="modal fade" id="formModal" tabindex="-1" role="dialog">
  <form action="<?= base_url('Input_nilai/simpan') ?>" method="POST">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Nilai A</label>
                    <input name="nilai_a" type="number" class="form-control" min="0" max="12" value="0">
                </div>
                <div class="form-group">
                    <label>Nilai B</label>
                    <input name="nilai_b" type="number" class="form-control" min="0" max="12" value="0">
                </div>
                <div class="form-group">
                    <label>Nilai C</label>
                    <input name="nilai_c" type="number" class="form-control" min="0" max="12" value="0">
                </div>
            </div>
